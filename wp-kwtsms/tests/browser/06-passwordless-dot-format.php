 ...
 * (e.g., +965.98765432) are correctly normalised to the stored format
...
return [
    ...
    'description' => 'Phone in +965.98765432 dot format is normalised and resolves the correct user for passwordless login.',
    ...
    'steps' => [
        ...
        [
            'step'        => 3,
            'action'      => 'fill',
            'description' => 'Enter phone in dot format: +965.98765432',
            'fields'      => [
                '[name="kwtsms_identifier"], [name="kwtsms_phone"], [name="log"], #user_login, [name="phone"]' => '+965.98765432',
            ],
    ...
    'expected_outcome' => 'Phone entered as +965.98765432 is normalised to 96598765432, the correct user is found, OTP is sent and verified, and the user lands on the dashboard.',
];
