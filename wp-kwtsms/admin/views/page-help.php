	...
	<div style="max-width:800px;">
		...
		<table class="widefat striped" style="max-width:800px;font-size:13px;">
			...
			<tbody>
				...
				<tr><td>ERR006 / ERR025</td><td><?php esc_html_e( 'Invalid phone number', 'wp-kwtsms' ); ?></td><td><?php esc_html_e( 'The number format is wrong. Ensure country code is included (e.g. 96599220322).', 'wp-kwtsms' ); ?></td></tr>
