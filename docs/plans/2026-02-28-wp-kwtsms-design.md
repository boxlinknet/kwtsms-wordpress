...
2. Hook `show_user_profile` and `edit_user_profile` → render phone number field:
   ...
   - Input: type="tel", placeholder="e.g. 96599220322"
...
2. Enter +96599220322 → save
   Expected: Saved as 96599220322 (normalized)
3. Enter ٩٦٥٩٩٢٢٠٣٢٢ (Hindi numerals) → save
   Expected: Converted to 96599220322
...
2. Add phone number to test user profile (96599220322)
3. Enable test mode, set test phone to 96599220322
...
2. Log in with 2FA
3. Expected: Phone normalized to 96599220322, OTP sent successfully
```
...
2. Ensure test user has phone 96599220322
3. Visit wp-login.php → Click "Login with SMS"
4. Enter 96599220322 → submit
...
2. Expected: Normalized to 96599220322, OTP sent
```
...
2. Ensure user has phone 96599220322
...
| Phone: `+96599220322` | Normalized and sent successfully |
| Phone: `0096599220322` | Normalized and sent successfully |
...
3. Disable test mode
4. Test all OTP flows end-to-end with real SMS to 96599220322
