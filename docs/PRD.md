...
| Test Phone Number | Text | Default: 96598765432; normalized on save |
...
965-9922-0322   → 96598765432
٩٦٥٩٩٢٢٠٣٢٢    → 96598765432  (Hindi/Arabic numerals → English)
...
| Invalid format | Please enter a valid phone number with country code (e.g. 96598765432). |
...
### Development Testing
- **Test phone:** `96598765432` (configured in Gateway Settings)
...
7. Confirm Test Phone is set to `96598765432`
