		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					...
					/>
					<p class="description">
						<?php esc_html_e( 'Enter phone number with country code (e.g. 96599220322 for Kuwait). Arabic/Eastern Arabic numerals are accepted. Used to receive OTP codes for login and password reset.', 'wp-kwtsms-otp' ); ?>
					</p>
					<?php if ( ! empty( $phone ) ) : ?>
						<p class="description">
