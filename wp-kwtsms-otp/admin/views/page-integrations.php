	...
	<table class="wp-list-table widefat fixed striped" style="max-width:960px;margin-top:16px;border-collapse:collapse;">
		<thead>
			<tr>
				...
				<th style="width:160px;padding:12px 16px;"><?php esc_html_e( 'Integration', 'wp-kwtsms-otp' ); ?></th>
				<th style="padding:12px 16px;"><?php esc_html_e( 'What it does', 'wp-kwtsms-otp' ); ?></th>
				<th style="width:130px;padding:12px 16px;"><?php esc_html_e( 'Plugin', 'wp-kwtsms-otp' ); ?></th>
				<th style="width:110px;padding:12px 16px;"><?php esc_html_e( 'SMS', 'wp-kwtsms-otp' ); ?></th>
		...
		<tbody>
			...
			<tr>
				...
				<td style="padding:14px 16px;vertical-align:middle;">
					<?php if ( $int['active'] ) : ?>
						<span style="color:#00a32a;font-weight:600;">&#10003; <?php esc_html_e( 'Installed', 'wp-kwtsms-otp' ); ?></span>
					<?php else : ?>
				...
				<td style="padding:14px 16px;vertical-align:middle;">
					<?php if ( ! $int['active'] ) : ?>
						<span style="color:#bbb;font-size:12px;"><?php esc_html_e( 'N/A', 'wp-kwtsms-otp' ); ?></span>
					<?php elseif ( $int['sms_enabled'] ) : ?>
						<span style="color:#00a32a;font-weight:600;">&#10003; <?php esc_html_e( 'On', 'wp-kwtsms-otp' ); ?></span>
					<?php else : ?>
						<span style="color:#d63638;font-weight:600;">&#10007; <?php esc_html_e( 'Off', 'wp-kwtsms-otp' ); ?></span>
					<?php endif; ?>
				</td>
				<td style="padding:14px 16px;vertical-align:middle;">
					<?php if ( $int['active'] ) : ?>
