...
3. Enter the phone number with country code (e.g. `96598765432` for Kuwait)
...
- OTP codes are written to `wp-content/debug.log` in the format:
  ```
  2026-02-28 12:00:00 [kwtsms-otp TEST] SMS to 96598765432: Your login code is: 123456. Valid for 3 minutes.
  ```
