...
3. Enter the number with country code — e.g. `96599220322`
...
| `965-9922-0322` | `96599220322` |
| `٩٦٥٩٩٢٢٠٣٢٢` (Arabic numerals) | `96599220322` |
| `۹۶۵۹۹۲۲۰۳۲۲` (Persian numerals) | `96599220322` |
| `(965) 9922.0322` | `96599220322` |
...
```
[tel kwtsms_phone placeholder "e.g. 96599220322"]
```
...
2. Enable **Test Mode**
3. Set **Test Phone** to your number (e.g. `96599220322`)
...
- OTP codes are written to `wp-content/debug.log`:
  ```
  [kwtsms-otp TEST] SMS to 96599220322: Your login code is: 123456. Valid for 5 minutes.
  ```
